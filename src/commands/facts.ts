    ...
    facts
        ...
        .action(async (opts) => {
            try {
                ...
                const data = await apiRequest<PageResponse<FactSchemaResponse>>(
                    'GET',
                    'schema/facts',
                    {
    ...
    facts
        ...
        .action(async (opts) => {
            try {
                ...
                const data = await apiRequest<FactSchemaResponse>(
                    'POST',
                    'schema/facts',
                    {
                        apiKey: globalOpts.apiKey,
...
function buildCreateBody(opts: Record<string, string | boolean | undefined>): Record<string, unknown> {
...
function buildUpdateBody(opts: Record<string, string | boolean | undefined>): Record<string, unknown> {
    const body: Record<string, unknown> = {};
