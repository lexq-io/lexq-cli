        ...
        'lexq_versions_create',
        {
            ...
            inputSchema: {
                ...
                effectiveFrom: z
                    .string()
                    .optional()
                    .describe('Effective start date (ISO 8601)'),
                effectiveTo: z
                    .string()
                    .optional()
                    .describe('Effective end date (ISO 8601)'),
            },
        },
        async ({ groupId, ...body }) =>
            callApi('POST', `policy-groups/${groupId}/versions`, { body })
    );
        ...
        'lexq_versions_clone',
        {
            ...
            inputSchema: {
                ...
                commitMessage: z
                    .string()
                    .optional()
                    .describe('Commit message for the cloned version'),
            },
        },
